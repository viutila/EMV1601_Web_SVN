...
cgi.prototype.getSpeedSearchId = function(camera,start_time,end_time,conditions,total,speed,unit,limit_low,limit_high){
	var tmpUrl = "../cgi-bin/Search.cgi?camera=" + camera + "&start_time=" + start_time + "&end_time=" + end_time + "&conditions=" + conditions + "&total=" + total + "&speed=" + speed + "&unit=" + unit + "&limit_low=" + limit_low + "&limit_high=" + limit_high;
	showMsg("getSearchId :" + tmpUrl);
	return this.ajax.getData(tmpUrl);
};
cgi.prototype.getBoarderCircleSearchId =  function(camera,start_time,end_time,conditions,total,type,mode,lat,long,radius,unit){
	var tmpUrl = "../cgi-bin/Search.cgi?camera=" + camera + "&start_time=" + start_time + "&end_time=" + end_time + "&conditions=" + conditions + "&total=" + total + "&type=" + type + "&mode=" + mode + "&lat=" + lat + "&long=" + long + "&radius=" + radius + "&unit=" + unit;
	showMsg("getSearchId :" + tmpUrl);
	return this.ajax.getData(tmpUrl);
};
cgi.prototype.getBoarderRectangleSearchId =  function(camera,start_time,end_time,conditions,total,type,mode,left_lat,left_long,right_lat,right_long){
	var tmpUrl = "../cgi-bin/Search.cgi?camera=" + camera + "&start_time=" + start_time + "&end_time=" + end_time + "&conditions=" + conditions + "&total=" + total + "&type=" + type + "&mode=" + mode + "&left_lat=" + left_lat + "&left_long=" + left_long + "&right_lat=" + right_lat + "&right_long=" + right_long;
	showMsg("getSearchId :" + tmpUrl);
	return this.ajax.getData(tmpUrl);
};
cgi.prototype.getGSensorSearchId = function(camera,start_time,end_time,conditions,total,gsensor,value_low,value_high){
	var tmpUrl = "../cgi-bin/Search.cgi?camera=" + camera + "&start_time=" + start_time + "&end_time=" + end_time + "&conditions=" + conditions + "&total=" + total + "&gsensor=" + gsensor + "&value_low=" + value_low + "&value_high=" + value_high;
	showMsg("getSearchId :" + tmpUrl);
	return this.ajax.getData(tmpUrl);
};
