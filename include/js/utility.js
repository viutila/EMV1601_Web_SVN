...
function CheckEmailUserName() {		//bChar 1:0-9 a-z '46 .','45 -','95 _','64 @'
    //args[0]	id
    var args = arguments;
    ...
    for (var i = len - 1; i >= 0; i--) {
        ...
        if ((ch >= 48) && (ch <= 57)) {			//0-9
            ...
            }else if((ch == 46) || (ch == 45) || (ch == 95) || (ch == 64)){
...
function CheckTitlePPPOE(){		//bChar 1:0-9 a-z '.','-','_'
	//args[0]	id
	var args = arguments;
	var tmpValue = getIdValue(args[0]);
	var len = tmpValue.length;
	...
	for(var i = len - 1;i >= 0;i--){
		...
		}else if((ch == 44) || (ch == 45) || (ch == 46) || (ch == 47) || (ch == 42) || (ch == 63) || (ch == 64) || (ch == 95)){
...
function CheckUnicodeTitleforMobilePhoneNumber(){		//not @ * & , / EFDEF_ ?
	//args[0]	id
	var args = arguments;
	var tmpValue = getIdValue(args[0]);
	var len = tmpValue.length;
	...
	for(var i = len - 1;i >= 0;i--){
		var ch = tmpValue.charCodeAt(i);
		//if((ch == 64) || (ch == 42) || (ch == 38)|| (ch == 44)|| (ch == 47)|| (ch == 36)|| (ch == 63)){
		if ( (ch == 32) || (ch == 45) || (ch == 46) || (ch == 64) || (ch == 95) || (ch == 44) || (ch == 47) || (ch == 42) || (ch == 63) || (ch == 35)) { //******* remove @ , / * ? #
...
function CheckFTPFilename() {		//not / * &
    ...
    for (var i = len - 1; i >= 0; i--) {
        ...
        if ((ch == 32) || (ch == 45) || (ch == 46) || (ch == 64) || (ch == 95) || (ch == 44) || (ch == 63) || (ch == 47)) {

        } else if ((ch == 38) || (ch == 42) ) { //******* block '*', '&'
            errFlag = 1;
            break;
        } else if ((ch >= 33) && (ch <= 47) || (ch >= 58) && (ch <= 63) || (ch >= 91) && (ch <= 96) || (ch >= 123) && (ch <= 126)) {
            errFlag = 1;
...
function setIdFocus(id){// for FireFox focus() issue 20131111 john add 
	window.setTimeout(function () { EFDEF_id(id).focus(); }, 0);
}
//-->